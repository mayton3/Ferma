...
# Путь для сохранения на Google Диске — папка GA_backup, создаётся автоматически
...
def genetic_algorithm(
    ...
    try:
        for gen in range(start_gen, generations):
            ...
            # Здесь добавляем определение часового пояса и получение локального времени
            timezone = pytz.timezone('Europe/Kiev')  # замените на ваш часовой пояс, например 'Europe/Moscow'
